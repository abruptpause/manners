export default {
  'consultantCare': {
    ...
    description: `Care Consultants can help individuals create living well end of life/aging plans, as well as the necessary documentation to ensure that an individual’s wishes are honored at the end.`,
    content: `<p>This includes a personal plan for the future to include advance directives, living plans, and family mediation.</p>
      <ul>
        <li>Help individuals an end of life living plan</li>
        <li>Explain what advance directives are:</li>
          <ul>
            <li>Living Will</li>
  ...
  'freeConsultation': {
    ...
    description: `Set up a 30-minute free consultation to discuss what your needs are and how I can help you.`,
    image: `stones-in-water.png`
  },
  'endOfLifeDuolaCare': {
    ...
    <ul>
      ...
      <li>Suggesting interventions for comfort</li>
      <li>Helping to facilitate unresolved issues</li>
      <li>Advanced Directives</li>
      <li>Planning the Vigil</li>
      <li>End of life Planning</li>
      <li>Writing the Obituary</li>
      <li>Writing the Eulogy</li>
      <li>Creating Remembrances</li>
      <li>Finding Peace and Acceptance - Helping the patient to find meaning in their life and what their contribution was to this life
      </li>
      <li>Support the Patient and Their Loved Ones through the Entire End of Life Journey</li>
    </ul>`,
    image: `holding-hands.png`
  },
  'hostingMonthlyDeathCafes': {
    title: `Hosting Monthly Death Cafes`,
    description: `Each month a new topic will be covered to help everyone become more comfortable talking about death and what a beautiful death would be for them.`,
